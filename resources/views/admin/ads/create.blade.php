                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group{{ $errors->has('start_date') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="start_date" id="input-name" class="datepicker form-control form-control-alternative{{ $errors->has('start_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Start Date') }}" required >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group{{ $errors->has('end_date') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="end_date" id="input-name" class="datepicker form-control form-control-alternative{{ $errors->has('end_date') ? ' is-invalid' : '' }}" placeholder="{{ __('End Date') }}" required >
